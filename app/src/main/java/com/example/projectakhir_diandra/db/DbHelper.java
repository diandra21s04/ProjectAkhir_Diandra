package com.example.projectakhir_diandra.db;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    @Override
    public void onUpgrade(SQLiteDatabase db,int oldVersion,int newVersion){ //Perintah DDL unutk Upgrade Tabel,dalam hal ini menghapus Tabel
    ...
    public ArrayList<Masyarakat> getAllUsers() {
        ArrayList<Masyarakat> userModelArrayList = new ArrayList<>();
